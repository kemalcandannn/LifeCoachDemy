...
def home_view(request):
    ...
    course_list = list(Course.objects.raw('SELECT * FROM course_course'))
    ...
    project_list = list(Project.objects.raw('SELECT * FROM project_project'))
    ...
    user_list = list(User.objects.raw('SELECT * FROM user_user'))
